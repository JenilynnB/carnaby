...
/**
 * Allows the Press This bookmarklet to create Directory entries. Doesn't work properly for some reason.
 * Original code found here: http://wordpress.org/support/topic/plugin-press-this-reloaded-press-this-custom-post-types
 * For whatever reason, uncommenting the add_filter line blows up the whole site
 *
 */
