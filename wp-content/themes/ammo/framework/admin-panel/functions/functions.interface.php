...
function optionsframework_add_admin() {
    ...
    $demo_import_page = add_submenu_page( 'theme-options',
											'Demo Data Importer',
											'Demo Data Importer',
											'edit_theme_options',
											'theme-options-importer',
											'demo_importer_submenu_page_callback'
										);
	...
	// Add framework functionaily to the head individually
	add_action("admin_print_scripts-$demo_import_page", 'demo_import_page_scripts_only');
	add_action("admin_print_styles-$demo_import_page",'demo_import_page_styles_only');
...
function optionsframework_options_page(){
	...
	*/	
	...
	include_once file_require( ADMIN_PATH . 'front-end/options.php' );
...
function of_ajax_callback() 
{
	...
	{
		of_save_options($options_machine->Defaults);
		reset_theme_color_options_handler();
		generate_css_from_less_hook( array('less_editor'=>get_theme_mod('less_editor')) );
		
        die('1'); //options reset
	}
	elseif( $save_type == 'reset_less' ){
		reset_theme_color_options_handler();
		generate_css_from_less_hook( array('less_editor'=>get_theme_mod('less_editor')) );
