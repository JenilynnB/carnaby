...
class LinkedInOAuth {
    ...
    * Set API URLS
    */
    function requestTokenURL() { return $this->LINKEDIN_API_ROOT.'uas/oauth/requestToken?scope=r_basicprofile+r_emailaddress'; }
    function authorizeURL() { return $this->LINKEDIN_API_ROOT.'uas/oauth/authenticate'; }
	function authenticateURL() { return $this->LINKEDIN_API_ROOT.'uas/oauth/authorize'; }
