...
function render_posts_carousel($posts){
    ...
    foreach($posts as $p){
        ...
        $response .=    '<article class="entry">';
        $response .=        '<div class="entry-media"">';
        $response .=            '<div class="entry-hover">';
        $response .=                '<div class="hover-icon">';
        $response .=                    '<a href="'.$post_link.'"><i class="fa fa-link"></i></a>';
        $response .=                '</div>';
        $response .=            '</div>';
        $response .=            '<div class="relative">';
        $response .=                '<div class="entry-title>';
        $response .=                    '<h2 itemprop="headline"><a href="" itemprop="url">'.$post_title.'</a></h2>';
        $response .=                '</div>';
        $response .=            '</div>';
        $response .=            '<img src="'.$post_image_url.'" class="img-responsive" />';
        $response .=        '</div>';
        $response .=    '</article>';
        $response .= '</div>';
