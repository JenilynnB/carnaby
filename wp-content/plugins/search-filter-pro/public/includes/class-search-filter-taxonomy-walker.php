...
class Search_Filter_Taxonomy_Walker extends Walker_Category {
	...
	function start_el( &$output, $category, $depth = 0, $args = array(), $id = 0 )
	{
		...
		else if(($this->type=="multiselect")||($this->type=="select"))
		{
			...
			$link = "<option class=\"level-".$this->multidepth." ".SF_ITEM_CLASS_PRE.$cat_id.$hidden."\" value='".$cat_id."'".$selected.$disabled." data-sf-cr='".SF_TAX_PRE.$cat_id."' data-sf-hide-empty='".intval($hide_empty)."'>".$pad.$cat_name;
