...
class Search_Filter_Post_Data_Validation {
	...
	private function clean_taxonomy_widget($widget_data)
	{
		...
		//{
			...
			$clean_widget['taxonomy_name'] = sanitize_key($widget_data['taxonomy_name']);
	...
	private function clean_sort_order_widget($widget_data)
	{
		...
		{
			//var_dump($widget_data['sort_options']);
			...
			//var_dump($clean_widget['sort_options']);
			//exit;
		}
	...
	private function clean_exclude_ids($exclude_ids)
	{
